...
//*************** ADC12CTL0 ***************/ //set number of cycles (fast mode)
    ...
    ADC12CTL0 |= ADC12SHT0_3 | ADC12MSC;  //32 cycles selected for bit field bits 8-111
...
//note: the last three value should all be defults, but they are stil set just in case
    ...
    //set ADC12CSTARTADD to 0 (first converision in ADC12MEM0)
   ...
   // ADC12VRSEL=0;
    ...
    ADC12MCTL1 |= ADC12INCH_4| ADC12VRSEL_0 |ADC12EOS;  //used for vertical result, use analog channel 4
